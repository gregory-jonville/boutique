...
<a class="navbar-brand" href="index.php">
		  <img src="./admin_area/assets/img/logos/store.png" width="80" height="80" alt="store">
</a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    ...
		    <form method="GET" action="" class="form-inline justify-content-center mu-2 my-2 my-lg-0">
